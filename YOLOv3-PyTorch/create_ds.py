...
ds_filter_train_base.to_csv(f"PASCAL_VOC/{config.BASE_CLASS}_{config.NEW_CLASS}_train_base.csv", index = False)
ds_filter_train_new.to_csv(f"PASCAL_VOC/{config.BASE_CLASS}_{config.NEW_CLASS}_train_new.csv", index = False)
ds_filter_test_base.to_csv(f"PASCAL_VOC/{config.BASE_CLASS}_{config.NEW_CLASS}_test_base.csv", index = False)
ds_filter_test_new.to_csv(f"PASCAL_VOC/{config.BASE_CLASS}_{config.NEW_CLASS}_test_new.csv", index = False)